...
async function seedDatabase() {
    try {
        ...
        const [trailBlazers, coreCrushers] = await Team_1.default.create([
            {
                name: 'Trail Blazers',
                city: 'Seattle',
        ...
        await Team_1.default.findByIdAndUpdate(trailBlazers._id, {
            members: [users[0]._id, users[1]._id],
        });
        await Team_1.default.findByIdAndUpdate(coreCrushers._id, {
